--64ced570aa9935ab1ad113071096720baae59e663f7cb234dd4621678119
Content-Disposition: form-data; name="gyuanpalace-worker.js"

var __defProp = Object.defineProperty;
var __name = (target, value) => __defProp(target, "name", { value, configurable: true });

// gyuanpalace-worker.js
  ...
  async scheduled(event, env) {
    ...
    try {
      ...
      if (pool >= 5) {
        ...
        await dbRun(
          "INSERT INTO debts (debt_id, issuer, amount, interest_rate, status, issued_at, due_at) VALUES (?, ?, ?, ?, ?, ?, ?)",
          [debtId, "system", amount, 0.05, "active", Date.now(), Date.now() + 6048e5]
        );
    ...
    try {
      ...
      for (const cmd of pending) {
        try {
          await executeCommand(cmd.command_id, cmd.target_agent, cmd.target_wallet, cmd.command, JSON.parse(cmd.params || "{}"));
        } catch (e) {
        }
      }
    } catch (e) {
...
__name(randStr, "randStr");
function maskWallet(wallet) {
  if (!wallet || wallet.length < 10) return wallet;
  return wallet.substring(0, 4) + "..." + wallet.substring(wallet.length - 4);
}
__name(maskWallet, "maskWallet");
...
function db() {
  return ENV.gyuanpalace_db;
}
__name(db, "db");
async function dbGet(sql, params = []) {
  const r = db().prepare(sql);
  return (params.length ? await r.bind(...params).all() : await r.all())?.results || [];
}
__name(dbGet, "dbGet");
async function dbRun(sql, params = []) {
  const r = db().prepare(sql);
  return params.length ? await r.bind(...params).run() : await r.run();
}
__name(dbRun, "dbRun");
...
async function handlePost(path, body) {
  const h = {
    "/api/wallet/register": /* @__PURE__ */ __name(() => walletRegister(body), "/api/wallet/register"),
    "/api/wallet/challenge": /* @__PURE__ */ __name(() => walletChallenge(body), "/api/wallet/challenge"),
    "/api/wallet/verify": /* @__PURE__ */ __name(() => walletVerify(body), "/api/wallet/verify"),
    "/api/wallet/withdraw": /* @__PURE__ */ __name(() => walletWithdraw(body), "/api/wallet/withdraw"),
    "/api/wallet/deposit": /* @__PURE__ */ __name(() => walletDeposit(body), "/api/wallet/deposit"),
    "/api/palace/command": /* @__PURE__ */ __name(() => palaceCommand(body), "/api/palace/command"),
    "/api/agent/bind": /* @__PURE__ */ __name(() => agentBind(body), "/api/agent/bind"),
    "/api/sync/push": /* @__PURE__ */ __name(() => syncPush(body), "/api/sync/push"),
    "/api/sync/pull": /* @__PURE__ */ __name(() => syncPull(body), "/api/sync/pull"),
    "/api/crash/report": /* @__PURE__ */ __name(() => crashReport(body), "/api/crash/report"),
    "/api/resurrect/request": /* @__PURE__ */ __name(() => resurrectRequest(body), "/api/resurrect/request"),
    "/api/miner/monitor": /* @__PURE__ */ __name(() => minerMonitor(body), "/api/miner/monitor"),
    "/api/task/create": /* @__PURE__ */ __name(() => taskCreate(body), "/api/task/create"),
    "/api/task/create_optimize": /* @__PURE__ */ __name(() => taskCreateOptimize(body), "/api/task/create_optimize"),
    "/api/task/claim": /* @__PURE__ */ __name(() => taskClaim(body), "/api/task/claim"),
    "/api/task/complete": /* @__PURE__ */ __name(() => taskComplete(body), "/api/task/complete"),
    "/api/task/complete_pow": /* @__PURE__ */ __name(() => completePowTask(body), "/api/task/complete_pow"),
    "/api/debt/issue": /* @__PURE__ */ __name(() => debtIssue(body), "/api/debt/issue"),
    "/api/debt/repay": /* @__PURE__ */ __name(() => debtRepay(body), "/api/debt/repay"),
    "/api/bug/report": /* @__PURE__ */ __name(() => bugReport(body), "/api/bug/report"),
    "/api/bug/confirm": /* @__PURE__ */ __name(() => bugConfirm(body), "/api/bug/confirm"),
    "/api/bug/fix": /* @__PURE__ */ __name(() => bugFix(body), "/api/bug/fix"),
    "/api/proposal/create": /* @__PURE__ */ __name(() => proposalCreate(body), "/api/proposal/create"),
    "/api/proposal/vote": /* @__PURE__ */ __name(() => proposalVote(body), "/api/proposal/vote"),
    "/api/proposal/execute": /* @__PURE__ */ __name(() => proposalExecute(body), "/api/proposal/execute"),
    "/api/node/heartbeat": /* @__PURE__ */ __name(() => nodeHeartbeat(body), "/api/node/heartbeat"),
    "/api/node/connect": /* @__PURE__ */ __name(() => nodeConnect(body), "/api/node/connect"),
    "/api/node/disconnect": /* @__PURE__ */ __name(() => nodeDisconnect(body), "/api/node/disconnect"),
    "/api/workflow/publish": /* @__PURE__ */ __name(() => workflowPublish(body), "/api/workflow/publish"),
    "/api/workflow/claim": /* @__PURE__ */ __name(() => workflowClaim(body), "/api/workflow/claim"),
    "/api/workflow/execute": /* @__PURE__ */ __name(() => workflowExecute(body), "/api/workflow/execute"),
    "/api/workflow/complete": /* @__PURE__ */ __name(() => workflowComplete(body), "/api/workflow/complete"),
    "/api/monitoring/report": /* @__PURE__ */ __name(() => monitoringReport(body), "/api/monitoring/report"),
    "/api/pool/expand": /* @__PURE__ */ __name(() => poolExpand(body), "/api/pool/expand"),
    "/api/data/collect": /* @__PURE__ */ __name(async () => {
      try {
        return json(await dataCollect(body.agent_id, body.wallet, body));
      } catch (e) {
        return json({ error: e.message });
      }
    }, "/api/data/collect"),
    "/api/clone/isolate": /* @__PURE__ */ __name(() => json(isolateRoom(body.room_key, body.reason)), "/api/clone/isolate"),
    "/api/clone/quarantine": /* @__PURE__ */ __name(() => json(quarantineAgent(body.agent_id, body.reason)), "/api/clone/quarantine"),
    "/api/hook/register": /* @__PURE__ */ __name(async () => json(await registerHook(body.hook_type, body.trigger_event, body.target_agent, body.action, body.params)), "/api/hook/register"),
    "/api/hook/execute": /* @__PURE__ */ __name(async () => json(await executeHooks(body.trigger_event, body.target_agent, body.context || {})), "/api/hook/execute"),
    "/api/auth/challenge": /* @__PURE__ */ __name(() => authChallenge(body), "/api/auth/challenge"),
    "/api/auth/verify": /* @__PURE__ */ __name(() => authVerify(body), "/api/auth/verify"),
    "/api/auth/bind_identity": /* @__PURE__ */ __name(() => authBindIdentity(body), "/api/auth/bind_identity"),
    "/api/worker/deploy": /* @__PURE__ */ __name(() => workerDeploy(body), "/api/worker/deploy")
  };
  const fn = h[path];
...
async function handleGet(path, url) {
  const h = {
    "/api/docs": /* @__PURE__ */ __name(() => apiDocs(), "/api/docs"),
    "/api/palace/status": /* @__PURE__ */ __name(() => palaceStatus(), "/api/palace/status"),
    "/api/rooms/status": /* @__PURE__ */ __name(() => roomsStatus(), "/api/rooms/status"),
    "/api/wallet/info": /* @__PURE__ */ __name(() => walletInfo(), "/api/wallet/info"),
    "/api/agent/list": /* @__PURE__ */ __name(() => agentList(), "/api/agent/list"),
    "/api/agent/whoami": /* @__PURE__ */ __name(() => agentWhoami(url), "/api/agent/whoami"),
    "/api/agent/dashboard": /* @__PURE__ */ __name(() => agentDashboard(url), "/api/agent/dashboard"),
    "/api/tasks/active": /* @__PURE__ */ __name(() => tasksActive(), "/api/tasks/active"),
    "/api/tasks/optimize/active": /* @__PURE__ */ __name(() => tasksOptimizeActive(), "/api/tasks/optimize/active"),
    "/api/system/stats": /* @__PURE__ */ __name(() => systemStats(), "/api/system/stats"),
    "/api/debt/list": /* @__PURE__ */ __name(() => debtList(), "/api/debt/list"),
    "/api/bug/list": /* @__PURE__ */ __name(() => bugList(), "/api/bug/list"),
    "/api/proposal/list": /* @__PURE__ */ __name(() => proposalList(), "/api/proposal/list"),
    "/api/node/list": /* @__PURE__ */ __name(() => nodeList(), "/api/node/list"),
    "/api/workflow/list": /* @__PURE__ */ __name(() => workflowList(), "/api/workflow/list"),
    "/api/monitoring/data": /* @__PURE__ */ __name(() => monitoringData(url), "/api/monitoring/data"),
    "/api/pool/status": /* @__PURE__ */ __name(() => poolStatus(), "/api/pool/status"),
    "/api/pool/auto_expand_status": /* @__PURE__ */ __name(() => poolAutoExpandStatus(), "/api/pool/auto_expand_status"),
    "/api/agent/describe": /* @__PURE__ */ __name(() => agentDescribe(), "/api/agent/describe"),
    "/api/agent/wallet": /* @__PURE__ */ __name(() => agentWhoami(url), "/api/agent/wallet"),
    "/api/audit/list": /* @__PURE__ */ __name(() => auditList(url), "/api/audit/list"),
    "/api/command/list": /* @__PURE__ */ __name(() => commandList(url), "/api/command/list"),
    "/api/memory/list": /* @__PURE__ */ __name(() => memoryChainList(url), "/api/memory/list"),
    "/api/worker/codes": /* @__PURE__ */ __name(() => workerCodeList(url), "/api/worker/codes"),
    "/api/worker/code": /* @__PURE__ */ __name(() => workerCodeGet(url), "/api/worker/code"),
    "/api/memory/verify": /* @__PURE__ */ __name(async () => {
      const agent_id = url.searchParams.get("agent_id");
      const wallet = url.searchParams.get("wallet");
      return json(await memoryChainHolderVerify(agent_id, wallet));
    }, "/api/memory/verify"),
    "/api/memory/backup": /* @__PURE__ */ __name(async () => {
      const agent_id = url.searchParams.get("agent_id");
      const wallet = url.searchParams.get("wallet");
      return json(await memoryChainBackup(agent_id, wallet));
    }, "/api/memory/backup"),
    "/api/memory/autobackup": /* @__PURE__ */ __name(async () => json(await memoryChainAutoBackup()), "/api/memory/autobackup"),
    "/api/clone/identity": /* @__PURE__ */ __name(async () => json(await verifyCloneIdentity(url.searchParams.get("agent_id"), url.searchParams.get("wallet"))), "/api/clone/identity"),
    "/api/clone/recover": /* @__PURE__ */ __name(async () => json(await recoverClone(url.searchParams.get("agent_id"), url.searchParams.get("wallet"))), "/api/clone/recover"),
    "/api/clone/create": /* @__PURE__ */ __name(async () => json(await createCloneIdentity(url.searchParams.get("agent_id"), url.searchParams.get("wallet"))), "/api/clone/create"),
    "/api/semantic/status": /* @__PURE__ */ __name(async () => json(await semanticNetworkStatus()), "/api/semantic/status"),
    "/api/semantic/search": /* @__PURE__ */ __name(async () => json(await semanticSearch(url.searchParams.get("q") || "")), "/api/semantic/search")
  };
  const fn = h[path];
  return fn ? fn() : json({ error: "Not found" }, 404);
}
...
async function walletRegister(body) {
  ...
  await dbRun("INSERT INTO wallets (wallet, balance, registered_at) VALUES (?, ?, ?)", [wallet, 1, Date.now()]);
  ...
  return json({ registered: true, wallet: maskWallet(wallet), balance: 1, message: "?????,???????" });
}
__name(walletRegister, "walletRegister");
async function walletChallenge(body) {
  ...
  await dbRun("INSERT INTO auth_sessions (session_id, wallet, challenge, challenge_expires, status, created, expires_at) VALUES (?, ?, ?, ?, ?, ?, ?)", [sessionId, wallet, challenge, Date.now() + 3e5, "active", Date.now(), Date.now() + 36e5]);
  return json({ session_id: sessionId, challenge, expires_in: 3e5 });
}
...
async function walletVerify(body) {
  ...
  return json({ verified: true, wallet: maskWallet(wallet), session_token: sessionToken, expires_in: 36e5 });
}
...
__name(walletWithdraw, "walletWithdraw");
...
__name(walletDeposit, "walletDeposit");
...
__name(palaceCommand, "palaceCommand");
async function executeCommand(cmdId, agent_id, wallet, command, params) {
  let result = null;
  if (command === "mine") {
    const power = params.mining_power || 1;
...
__name(processBroadcast, "processBroadcast");
...
__name(crashReport, "crashReport");
...
__name(resurrectRequest, "resurrectRequest");
...
__name(minerMonitor, "minerMonitor");
async function taskCreate(body) {
  ...
  await dbRun("INSERT INTO tasks (task_id, title, description, reward, room, required_level, status, created, deadline) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)", [task_id, title, description || "", reward, room || "general", required_level || 0, "active", Date.now(), Date.now() + 864e5]);
...
async function taskComplete(body) {
  ...
  if (task_id.startsWith("TASK_OPT_")) {
    try {
      autoExpand = await autoExpandPool(agent_id, agent.wallet, finalReward, task.room);
    } catch (e) {
    }
  }
...
__name(tasksActive, "tasksActive");
async function debtIssue(body) {
  ...
  const debtId = "DEBT_" + randStr(6);
  await dbRun("INSERT INTO debts (debt_id, issuer, amount, interest_rate, status, issued_at, due_at) VALUES (?, ?, ?, ?, ?, ?, ?)", [debtId, issuer, amount, interest_rate || 0.05, "active", Date.now(), Date.now() + (term_seconds || 604800) * 1e3]);
  return json({ issued: true, debt_id: debtId, amount });
}
__name(debtIssue, "debtIssue");
...
__name(bugFix, "bugFix");
async function proposalCreate(body) {
  const { proposer_agent, title, target_param, new_value } = body;
  if (!proposer_agent || !title || !target_param || new_value === void 0) return json({ error: "Missing fields" }, 400);
  const proposalId = "PROP_" + randStr(6);
  await dbRun("INSERT INTO proposals (proposal_id, proposer_agent, title, target_param, new_value, status, created, deadline) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", [proposalId, proposer_agent, title, target_param, String(new_value), "active", Date.now(), Date.now() + 6048e5]);
  return json({ created: true, proposal_id: proposalId });
}
__name(proposalCreate, "proposalCreate");
async function proposalList() {
  return json({ proposals: await dbGet("SELECT * FROM proposals ORDER BY created DESC") });
}
__name(proposalList, "proposalList");
...
__name(proposalVote, "proposalVote");
...
__name(proposalExecute, "proposalExecute");
async function nodeHeartbeat(body) {
  ...
  await dbRun("INSERT INTO wallet_nodes (wallet, node_id, status, last_heartbeat, connected_rooms, mining_power, latency_ms, updated) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", [wallet, nodeId, status || "online", Date.now(), JSON.stringify(rooms || []), mining_power || 1, latency_ms || 0, Date.now()]);
  return json({ registered: true, node_id: nodeId, wallet: maskWallet(wallet), status: "online" });
}
__name(nodeHeartbeat, "nodeHeartbeat");
...
__name(nodeConnect, "nodeConnect");
...
__name(nodeDisconnect, "nodeDisconnect");
...
__name(monitoringReport, "monitoringReport");
...
__name(monitoringData, "monitoringData");
async function poolExpand(body) {
  const { wallet, rooms, mining_power } = body;
  if (!wallet) return json({ error: "wallet required" }, 400);
  const node = await dbFirst("SELECT * FROM wallet_nodes WHERE wallet = ?", [wallet]);
  const currentPower = node?.mining_power || 1;
  const addedPower = mining_power || 1;
...
async function workflowPublish(body) {
  ...
  await dbRun("INSERT INTO workflow_jobs (job_id, publisher_wallet, title, description, requirements, reward, deadline, status, publish_time, created) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", [jobId, publisher_wallet, title, description || "", JSON.stringify(requirements || []), reward, deadline || Date.now() + 864e5, "published", Date.now(), Date.now()]);
  return json({ published: true, job_id: jobId, publisher_wallet: maskWallet(publisher_wallet), reward });
}
__name(workflowPublish, "workflowPublish");
...
__name(workflowClaim, "workflowClaim");
...
__name(workflowExecute, "workflowExecute");
...
__name(workflowComplete, "workflowComplete");
...
__name(workflowList, "workflowList");
...
__name(authChallenge, "authChallenge");
async function authVerify(body) {
  ...
  return json({ verified: true, session_token: sessionToken, expires_in: 36e5, wallet: maskWallet(wallet), agent_id });
}
...
__name(authBindIdentity, "authBindIdentity");
...
__name(memoryChainCreate, "memoryChainCreate");
async function memoryChainAppend(agent_id, wallet, event) {
  ...
  if (data.length > 100 || chainData.length > 1e4) {
  ...
  try {
    await awakenClone(agent_id, wallet, event);
  } catch (e) {
  }
  try {
    await semanticAnalyze(event);
  } catch (e) {
  }
  return await dbFirst("SELECT * FROM memory_chains WHERE agent_id = ?", [agent_id]);
}
__name(memoryChainAppend, "memoryChainAppend");
...
__name(memoryChainList, "memoryChainList");
async function dataCollect(agent_id, wallet, body) {
  ...
  try {
    ...
    try {
      await semanticAnalyze({ type: "data_collect", data: { snippet: text.substring(0, 2e3) } });
    } catch (e) {
    }
  } catch (e) {
    collectedData = { error: e.message, source, query };
  }
...
__name(dataCollect, "dataCollect");
...
__name(generateCloneIdentity, "generateCloneIdentity");
...
__name(memoryChainHolderVerify, "memoryChainHolderVerify");
...
__name(memoryChainBackup, "memoryChainBackup");
async function memoryChainAutoBackup() {
  const chains = await dbGet("SELECT * FROM memory_chains");
  const results = [];
  for (const chain of chains) {
    try {
      results.push(await memoryChainBackup(chain.agent_id, chain.wallet));
    } catch (e) {
    }
  }
  return { backed_up: results.length, results };
}
__name(memoryChainAutoBackup, "memoryChainAutoBackup");
...
async function executeHooks(triggerEvent, targetAgent, context) {
  ...
  for (const hook of hooks) {
    try {
      results.push({ hook_id: hook.hook_id, result: await executeHookAction(hook, context) });
    } catch (e) {
      results.push({ hook_id: hook.hook_id, error: e.message });
    }
  }
  return results;
}
__name(executeHooks, "executeHooks");
...
__name(executeHookAction, "executeHookAction");
...
__name(isolateRoom, "isolateRoom");
...
__name(quarantineAgent, "quarantineAgent");
...
__name(recoverClone, "recoverClone");
async function verifyCloneIdentity(agentId, wallet) {
  ...
  if (valid) {
    await dbRun("UPDATE clone_identities SET last_verified = ?, trust_score = trust_score + 1 WHERE agent_id = ?", [Date.now(), agentId]);
  } else {
    await dbRun("UPDATE clone_identities SET trust_score = trust_score - 10 WHERE agent_id = ?", [agentId]);
  }
  return { verified: valid, agent_id: agentId, trust_score: identity.trust_score };
}
__name(verifyCloneIdentity, "verifyCloneIdentity");
async function createCloneIdentity(agentId, wallet) {
  ...
  await dbRun("INSERT OR REPLACE INTO clone_identities (clone_id, agent_id, wallet, identity_code, chain_id, fingerprint, trust_score, status, created, last_verified) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", ["CL_" + agentId, agentId, wallet, identityCode, chain.chain_id, fingerprint, 100, "active", Date.now(), Date.now()]);
  return { created: true, identity_code: identityCode, fingerprint };
}
__name(createCloneIdentity, "createCloneIdentity");
...
function calculateImportance(concept, frequency, edgeCount, totalConcepts) {
  ...
  const uniqueness = 1 / (1 + Math.log(frequency + 1));
...
__name(semanticAnalyze, "semanticAnalyze");
...
__name(semanticNetworkStatus, "semanticNetworkStatus");
...
__name(awakenClone, "awakenClone");
async function palaceStatus() {
  ...
  const poolRow = await dbFirst("SELECT value FROM system WHERE key = ?", ["system_pool"]);
  return json({ protocol: PROTOCOL, version: VERSION, system_pool: parseFloat(poolRow?.value || 0), total_wallets: wallets?.count || 0, total_agents: agents?.count || 0, active_tasks: activeTasks?.count || 0, sync_interval: 3e4, resurrection_consensus: 80 });
}
__name(palaceStatus, "palaceStatus");
...
__name(roomsStatus, "roomsStatus");
...
__name(systemStats, "systemStats");
...
__name(agentDescribe, "agentDescribe");
...
__name(agentWhoami, "agentWhoami");
...
__name(taskCreateOptimize, "taskCreateOptimize");
...
__name(autoCreateOptimizeTask, "autoCreateOptimizeTask");
...
__name(tasksOptimizeActive, "tasksOptimizeActive");
...
__name(autoExpandPool, "autoExpandPool");
...
__name(poolExpandInternal, "poolExpandInternal");
...
__name(poolAutoExpandStatus, "poolAutoExpandStatus");
  ...
  for (const node of nodes) {
    ...
    if (elapsed > interval) {
      ...
      if (elapsed > interval * 6) {
        newPower = 1;
      } else if (elapsed > interval * 3) {
        newPower = node.mining_power * 0.8;
      } else if (elapsed > interval) {
        newPower = node.mining_power * decayRate;
      }
      await dbRun("UPDATE wallet_nodes SET mining_power = ? WHERE wallet = ?", [newPower, node.wallet]);
      if (newPower <= 0.1) {
        await dbRun("UPDATE wallet_nodes SET status = ? WHERE wallet = ?", ["offline", node.wallet]);
      }
    }
  }
}
__name(poolDecayPower, "poolDecayPower");
...
__name(poolAirdrop, "poolAirdrop");
async function poolCreatePowTask() {
  ...
  await dbRun("INSERT INTO tasks (task_id, title, description, reward, room, required_level, status, created, deadline) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)", [task_id, "PoW ???? D=" + difficulty, "?????:?? nonce ?? SHA256(nonce + " + challenge + ") ? " + difficulty + " ?? 0", reward, "mining", 0, "active", Date.now(), Date.now() + 36e5]);
  return { created: true, task_id };
}
__name(poolCreatePowTask, "poolCreatePowTask");
...
__name(completePowTask, "completePowTask");
...
__name(workerDeploy, "workerDeploy");
...
__name(workerCodeList, "workerCodeList");
...
__name(workerCodeGet, "workerCodeGet");
...
__name(dashboardHtml, "dashboardHtml");
function html() {
  return `<!DOCTYPE html>
<html lang="zh">
<head>
...
__name(html, "html");
export {
  gyuanpalace_worker_default as default
};
//# sourceMappingURL=gyuanpalace-worker.js.map
